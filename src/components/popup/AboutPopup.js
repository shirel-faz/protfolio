...
import { EmailTemplates } from "../../core/utils/email-js/email-js.model";
        ...
        <div className="left">
          <div className="left_inner">
              ...
              <ul>
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>
                      <a style={{"fontSize":"11px"}} href={`mailto:${aboutData.email}`}>
                        {aboutData.email}
                      </a>
                    </span>
                  </div>
            ...
            <div className="edrea_tm_button full">
              <a href="img/about/SHIREL-FULLSTACK-RESUME.pdf" download onClick={sendMailCv}>
                Download CV
              </a>
            </div>
          </div>
        ...
        <div className="right">
          <div className="right_inner">
            <div className="biography">
              ...
              <div className="text">
              <p>
                  As a frontend developer, I focus on crafting intuitive user interfaces that are easy to use and navigate, while also paying close attention to performance and accessibility. I also have a strong background in mobile development, and have created a variety of apps that are available on both the App Store and Google Play.
                  <br/>
                  <br/>
                  Throughout my career, I've worked on projects of all sizes, from small startups to large enterprises. I'm a firm believer in using agile methodologies like Scrum to ensure that development stays on track and that deliverables are met on time and within budget.
                  <br/>
                  <br/>
                  Thank you for taking the time to visit my portfolio. If you're interested in working together or would like to learn more about my experience and skills, please don't hesitate to get in touch!
                </p>
              </div>
            </div>
